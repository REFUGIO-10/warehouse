...
- [ ] **Re-medir layouts (2×2 / 2×3 / baseline) a `--count 20+`** para saber si el layout mueve de verdad en oficial.
- [ ] Para batir 888: policy más fuerte (`tools/sweep_params.py`: `WINDOW`/`NODE_CAP`/replan) o portar lo de Equipo 03.
